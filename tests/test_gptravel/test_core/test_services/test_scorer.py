...
def test_add_score(score_container: TravelPlanScore):
    score_container.add_score("type score", {"score_value": 100, "score_weight": 0.11})
    score_container.add_score("score livel", {"score_value": 80, "score_weight": 0.23})
    score_container.add_score("score basso", {"score_value": 60, "score_weight": 0.15})
    score_container.add_score("score extra", {"score_value": 90, "score_weight": 0.10})
...
def test_weighted_score(score_container: TravelPlanScore):
    score_container.add_score("type score", {"score_value": 100, "score_weight": 0.11})
    score_container.add_score("score livel", {"score_value": 80, "score_weight": 0.23})
    score_container.add_score("score basso", {"score_value": 60, "score_weight": 0.15})
...
def test_weighted_score_empty(score_container: TravelPlanScore):
...
def test_day_generation_scorer_with_correct_days_travel_plan(
    ...
    day_generation_scorer.score(
        travel_plan=travel_plan_single_city_per_day, travel_plan_scores=score_container
    )
...
def test_day_generation_scorer_with_no_correct_days_travel_plan(
    ...
    day_generation_scorer.score(
        travel_plan=travel_plan_multiple_city_per_day,
